  ...
  return (
    <div id='recent'>
        <div className="recent-header">
            <h2 className='recent-header-head'>RECENT POST</h2>
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 160 6">
        ...
        <div className="recent-posts">
          <div className="recent-posts-post" onClick={()=>{navigate("/blog")}}>
            <div className="recent-post-image">
            <img src="https://demo2.wpopal.com/striz/wp-content/uploads/2018/12/blog-1-1-750x500.jpg" alt="" />
            </div>
            <div className="recent-post-date">
              <p>03 FEV,2022</p>
            </div>
            <div className="recent-posts-post-text">
                <p>IN <span>HEALTHY </span> . POSTED BY <span>ADMIN</span></p>
                <h3 className='recent-post-h3'>SHOULD YOU USE A SHAVE CREAM OR SHAVE GEL?</h3>
            </div>
          </div>
          <div className="recent-posts-post" onClick={()=>{navigate("/blog")}}>
            <div className="recent-post-image"><img src="https://demo2.wpopal.com/striz/wp-content/uploads/2018/12/blog-2-1-750x501.jpg" alt="" /></div>
            <div className="recent-post-date">
              <p>03 FEV,2022</p>
            </div>
            <div className="recent-posts-post-text">
                <p>IN <span>FASHION, </span>  <span>HEALTHY </span> . POSTED BY <span>ADMIN</span></p>
                <h3 className='recent-post-h3'>FACE THE NEW YEAR WITH THE REAL SHAVING COMPANY!</h3>
            </div>
          </div>
          <div className="recent-posts-post" onClick={()=>{navigate("/blog")}}>
           <div className="recent-post-image">
           <img src="https://demo2.wpopal.com/striz/wp-content/uploads/2018/12/blog-3-1-750x501.jpg" alt="" />
           </div>
            <div className="recent-post-date">
              <p>02 FEV,2022</p>
            </div>
